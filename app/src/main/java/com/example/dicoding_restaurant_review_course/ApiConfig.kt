...
//import com.example.dicoding_restaurant_review_course.ui.MainViewModel
...
//class ApiConfig {
//    companion object {
//        fun getApiService(context: MainViewModel): ApiService {
...
//            val cache = Cache(context.ca, cacheSize)
//
